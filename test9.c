...
void drawCube(Texture2D *cubes , int frames, double **heightMutationMap, int **map, Camera2D camera, Vector2 cameraDelta){
...
int main(void)
{
  ...
  while (!WindowShouldClose()) {
    ...
    drawCube(textures, framesCounter, heightMutationMap2, map, camera,cameraDelta);
